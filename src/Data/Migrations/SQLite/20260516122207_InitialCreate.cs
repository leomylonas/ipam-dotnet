    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllocationTags", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    TenancyId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubnetTenancyAccesses", x => new { x.SubnetId, x.TenancyId });
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AllocationTags_AllocationId_Key",
                table: "AllocationTags",
                columns: new[] { "AllocationId", "Key" },
                unique: true);
